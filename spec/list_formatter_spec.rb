# Run the spec by running the command: rspec spec/list_formatter_spec.rb"

require 'spec_helper'

describe Dradis::Plugins::Nexpose::ListFormatter do
  ...
  it 'parses the <UnorderedList> and <OrderedList> elements' do
    expect(Dradis::Plugins::Nexpose::ListFormatter.new.format_list(source)).to eq(
      "* Microsoft Windows\n"\
